...
2. Start the desktop UI or run CLI tools from the repository as documented.
...
- The application includes embedded XML template structure for consistent exports.
